                    ...
                    <div className="rounded-md -space-y-px">
                        <div className="mb-4">
                            ...
                            <input
                                ...
                                } dark:border-gray-700 dark:bg-gray-900 dark:text-white text-gray-900 focus:outline-none focus:ring-2 sm:text-sm`}
                    ...
                    <div className="flex items-center justify-between">
                        <div className="flex items-center">
                            <input
                                ...
                                name="remember-me"
                                type="checkbox"
                                className="h-4 w-4 text-indigo-600 focus:ring-indigo-500 border-gray-300 rounded dark:border-gray-700 dark:bg-gray-900"
                            />
                            <label
                                htmlFor="remember-me"
